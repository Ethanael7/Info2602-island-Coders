...
# @auth_views.route('/browseExercises_page/search', method=['GET'])
@jwt_required()
def browseExercises_page(workout_id=None, exercise_id=None, intNewWorkout=0):
    q = request.args.get('q', default='', type=str)
    exercises = Exercise.searchResults(q)
    ...
    if intNewWorkout == 1:
        ...
        new_workout = False
    return render_template('browseExercises.html', exercises=exercises, workout_id=workout_id, exercise_id=exercise_id, new_workout=new_workout, q=q)
